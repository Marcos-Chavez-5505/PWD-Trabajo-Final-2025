...
if ($idProducto > 0) {
    ...
    if ($carrito->eliminarDelCarrito($idUsuario, $idProducto)){
        echo json_encode(['ok' => true, 'msg' => 'Producto borrado del carrito.']);
    }else{
        echo json_encode(['ok' => false, 'msg' => 'No se pudo borrar el producto']);    
    }
} else {
    echo json_encode(['ok' => false, 'msg' => 'SOLO PARA DEBUGGEAR']);
}
?>
